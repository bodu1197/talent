...
CREATE UNIQUE INDEX advertising_campaigns_pkey ON public.advertising_campaigns USING btree (id);
...
CREATE UNIQUE INDEX advertising_credits_pkey ON public.advertising_credits USING btree (id);
...
CREATE UNIQUE INDEX advertising_impressions_pkey ON public.advertising_impressions USING btree (id);
...
CREATE UNIQUE INDEX advertising_payments_pkey ON public.advertising_payments USING btree (id);
...
CREATE UNIQUE INDEX advertising_subscriptions_pkey ON public.advertising_subscriptions USING btree (id);
...
CREATE UNIQUE INDEX category_visits_pkey ON public.category_visits USING btree (id);
...
CREATE UNIQUE INDEX chat_favorites_pkey ON public.chat_favorites USING btree (id);
...
CREATE UNIQUE INDEX earnings_transactions_pkey ON public.earnings_transactions USING btree (id);
...
CREATE UNIQUE INDEX errand_applications_pkey ON public.errand_applications USING btree (id);
...
CREATE UNIQUE INDEX errand_chat_messages_pkey ON public.errand_chat_messages USING btree (id);
...
CREATE UNIQUE INDEX errand_disputes_pkey ON public.errand_disputes USING btree (id);
CREATE INDEX idx_errand_disputes_status ON public.errand_disputes USING btree (status);
CREATE UNIQUE INDEX errand_locations_pkey ON public.errand_locations USING btree (id);
CREATE INDEX idx_errand_locations_errand ON public.errand_locations USING btree (errand_id);
CREATE UNIQUE INDEX errand_messages_pkey ON public.errand_messages USING btree (id);
...
CREATE UNIQUE INDEX errand_reviews_pkey ON public.errand_reviews USING btree (id);
...
CREATE UNIQUE INDEX errand_settlements_pkey ON public.errand_settlements USING btree (id);
...
CREATE UNIQUE INDEX errand_stops_pkey ON public.errand_stops USING btree (id);
CREATE UNIQUE INDEX errands_pkey ON public.errands USING btree (id);
...
CREATE UNIQUE INDEX food_carts_pkey ON public.food_carts USING btree (id);
CREATE UNIQUE INDEX food_carts_user_id_store_id_key ON public.food_carts USING btree (user_id, store_id);
CREATE UNIQUE INDEX food_menu_categories_pkey ON public.food_menu_categories USING btree (id);
CREATE UNIQUE INDEX food_menu_option_groups_pkey ON public.food_menu_option_groups USING btree (id);
CREATE UNIQUE INDEX food_menu_option_items_pkey ON public.food_menu_option_items USING btree (id);
CREATE UNIQUE INDEX food_menus_pkey ON public.food_menus USING btree (id);
...
CREATE UNIQUE INDEX food_orders_pkey ON public.food_orders USING btree (id);
...
CREATE UNIQUE INDEX food_reviews_pkey ON public.food_reviews USING btree (id);
CREATE INDEX idx_food_reviews_store ON public.food_reviews USING btree (store_id);
CREATE UNIQUE INDEX food_store_favorites_pkey ON public.food_store_favorites USING btree (id);
...
CREATE UNIQUE INDEX food_stores_pkey ON public.food_stores USING btree (id);
...
CREATE UNIQUE INDEX helper_profiles_pkey ON public.helper_profiles USING btree (id);
...
CREATE UNIQUE INDEX helper_subscriptions_pkey ON public.helper_subscriptions USING btree (id);
CREATE INDEX idx_helper_subscriptions_helper ON public.helper_subscriptions USING btree (helper_id);
CREATE UNIQUE INDEX helper_withdrawals_pkey ON public.helper_withdrawals USING btree (id);
...
CREATE UNIQUE INDEX order_settlements_pkey ON public.order_settlements USING btree (id);
...
CREATE UNIQUE INDEX portfolio_services_pkey ON public.portfolio_services USING btree (id);
...
CREATE UNIQUE INDEX premium_placements_pkey ON public.premium_placements USING btree (id);
...
CREATE UNIQUE INDEX quote_responses_pkey ON public.quote_responses USING btree (id);
...
CREATE UNIQUE INDEX seller_earnings_pkey ON public.seller_earnings USING btree (id);
...
CREATE UNIQUE INDEX seller_portfolio_pkey ON public.seller_portfolio USING btree (id);
...
CREATE UNIQUE INDEX service_categories_pkey ON public.service_categories USING btree (service_id, category_id);
...
CREATE UNIQUE INDEX service_favorites_pkey ON public.service_favorites USING btree (id);
...
CREATE UNIQUE INDEX service_revision_categories_pkey ON public.service_revision_categories USING btree (id);
...
CREATE UNIQUE INDEX service_revisions_pkey ON public.service_revisions USING btree (id);
CREATE UNIQUE INDEX service_tags_pkey ON public.service_tags USING btree (service_id, tag_id);
...
CREATE UNIQUE INDEX service_view_logs_pkey ON public.service_view_logs USING btree (id);
...
CREATE UNIQUE INDEX service_views_pkey ON public.service_views USING btree (id);
...
CREATE UNIQUE INDEX settlement_details_pkey ON public.settlement_details USING btree (id);
...
CREATE UNIQUE INDEX tax_invoices_pkey ON public.tax_invoices USING btree (id);
...
CREATE UNIQUE INDEX visitor_stats_daily_pkey ON public.visitor_stats_daily USING btree (id);
...
CREATE UNIQUE INDEX visitor_stats_hourly_pkey ON public.visitor_stats_hourly USING btree (id);
...
CREATE UNIQUE INDEX visitor_stats_monthly_pkey ON public.visitor_stats_monthly USING btree (id);
