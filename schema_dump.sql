...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "last_mode" "text" DEFAULT 'buyer'::"text",
    CONSTRAINT "users_last_mode_check" CHECK (("last_mode" = ANY (ARRAY['buyer'::"text", 'seller'::"text"]))),
    CONSTRAINT "users_user_type_check" CHECK (("user_type" = ANY (ARRAY['buyer'::"text", 'seller'::"text", 'both'::"text", 'admin'::"text"])))
);
...
COMMENT ON TABLE "public"."users" IS '회원 기본 정보 테이블';



COMMENT ON COLUMN "public"."users"."user_type" IS '회원 유형: buyer(구매자), seller(판매자), both(둘다), admin(관리자)';



COMMENT ON COLUMN "public"."users"."last_mode" IS '마지막 방문 페이지 모드 (buyer/seller)';
...
CREATE INDEX "idx_users_last_mode" ON "public"."users" USING "btree" ("last_mode");
...
ALTER TABLE ONLY "public"."premium_placements"
    ADD CONSTRAINT "premium_placements_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id");
...
ALTER TABLE ONLY "public"."search_logs"
    ADD CONSTRAINT "search_logs_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id");
...
ALTER TABLE ONLY "public"."service_categories"
    ADD CONSTRAINT "service_categories_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE CASCADE;
