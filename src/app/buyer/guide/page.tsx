    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container-1200">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">구매자 이용 가이드</h1>

          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">서비스 구매 방법</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">주문 후 진행 절차</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>결제 완료 후 판매자가 작업을 시작합니다</li>
                <li>작업 진행 상황은 마이페이지 &gt; 주문내역에서 확인할 수 있습니다</li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Q. 결제 후 취소가 가능한가요?</h3>
                  <p className="text-gray-700">작업 시작 전에는 전액 환불이 가능합니다. 작업 진행 중인 경우 판매자와 협의가 필요합니다.</p>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Q. 판매자와 어떻게 소통하나요?</h3>
                  <p className="text-gray-700">마이페이지의 메시지 기능을 통해 판매자와 직접 소통할 수 있습니다.</p>
                </div>
              </div>
            </section>
          </div>
