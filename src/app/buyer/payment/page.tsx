    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container-1200">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">결제 안내</h1>

          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">이용 가능한 결제 수단</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">결제 프로세스</h2>
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                ...
                <i className="fas fa-arrow-right text-gray-400 hidden md:block"></i>
                <div className="flex-1 bg-gray-50 rounded-lg p-4 text-center">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">안전한 결제</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">캐시 충전</h2>
