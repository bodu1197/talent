    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container-1200">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">주문 방법 안내</h1>

          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">처음 주문하시나요?</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">주문 시 유의사항</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">도움이 필요하신가요?</h2>
              <p className="text-gray-700 mb-4">
