    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container-1200">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-semibold text-gray-900 mb-6">주문 방법 안내</h1>

          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">처음 주문하시나요?</h2>
              <p className="text-gray-700 mb-4">
                재능 마켓플레이스에서 원하는 서비스를 주문하는 방법을 단계별로 안내해드립니다.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">상세 주문 가이드</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-brand-primary pl-4">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">STEP 5. 결제하기</h3>
                ...
                <div className="border-l-4 border-brand-primary pl-4">
                  ...
                  <p className="text-gray-700 mb-2">결제 완료 후 전문가와 메시지로 소통합니다.</p>
                  <ul className="list-disc list-inside text-gray-600 space-y-1">
                    <li>작업 요청사항 재확인</li>
                    <li>작업 진행 상황 확인</li>
                    <li>수정 요청 및 피드백</li>
                ...
                <div className="border-l-4 border-brand-primary pl-4">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">STEP 8. 리뷰 작성</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">주문 시 유의사항</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">도움이 필요하신가요?</h2>
              <p className="text-gray-700 mb-4">
