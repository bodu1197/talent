        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">환불 가능 기준</h2>
              <div className="space-y-4">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h3 className="font-bold text-green-900 mb-2">✓ 전액 환불 가능한 경우</h3>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h3 className="font-bold text-yellow-900 mb-2">⚠ 부분 환불 가능한 경우</h3>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <h3 className="font-bold text-red-900 mb-2">✗ 환불 불가능한 경우</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">환불 신청 방법</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                <li>마이페이지 &gt; 주문내역에서 해당 주문 선택</li>
                <li>환불 신청 버튼 클릭</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">환불 처리 기간</h2>
