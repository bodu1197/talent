      ...
      <div className="bg-[#0f3460] text-white">
        <div className="container-1200 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link
              href="/auth/register"
              className="inline-block bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-lg px-8 py-4 rounded-lg transition-all"
            >
              지금 무료로 시작하기 →
            </Link>
          </div>
        ...
        <div className="container-1200">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="bg-white border-2 border-gray-200 p-6 rounded-lg">
              <div className="text-[#0f3460] font-bold text-lg mb-3">💸 수수료 스트레스</div>
            ...
            <div className="bg-white border-2 border-gray-200 p-6 rounded-lg">
              <div className="text-[#0f3460] font-bold text-lg mb-3">📈 가격 부담의 악순환</div>
              <div className="space-y-2 text-gray-700 text-sm">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 rounded-lg">
              <div className="text-[#0f3460] font-bold text-lg mb-3">😤 억울한 손실</div>
              <div className="space-y-2 text-gray-700 text-sm">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 rounded-lg">
              <div className="text-[#0f3460] font-bold text-lg mb-3">😔 가격 경쟁력 상실</div>
              <div className="space-y-2 text-gray-700 text-sm">
          ...
          <div className="bg-[#0f3460] text-white p-8 rounded-lg mt-8 max-w-5xl mx-auto text-center">
            <div className="text-2xl font-bold mb-4">✨ 해결책은 간단합니다</div>
        ...
        <div className="container-1200">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-100 p-8 rounded-lg">
              <div className="text-gray-500 font-bold text-sm mb-4">❌ 타 플랫폼 (수수료 20%)</div>
              <div className="space-y-3 text-gray-700">
                <p>😰 수수료 때문에 가격을 높게 책정</p>
                <p>📉 높은 가격 → 주문 감소</p>
                <p>💸 적은 주문 + 수수료 차감 = 낮은 수익</p>
                <p>😔 스트레스만 쌓이고 포기하고 싶음</p>
              </div>
            </div>

            <div className="bg-[#0f3460] text-white p-8 rounded-lg">
              <div className="text-yellow-400 font-bold text-sm mb-4">✅ 우리 플랫폼 (수수료 0%)</div>
              <div className="space-y-3">
                <p>😊 수수료 걱정 없이 합리적 가격 책정</p>
                <p>📈 경쟁력 있는 가격 → 주문 증가</p>
                <p>💰 많은 주문 × 수수료 0원 = 최고 수익</p>
                <p>🎉 더 많이 벌고 더 행복해짐!</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-3">
                  <div className="font-bold text-gray-900">김디자이너</div>
              ...
              <div className="bg-[#0f3460]/10 p-3 rounded text-sm text-[#0f3460]">
                💡 저렴한 가격으로 더 많이 벌어요
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-3">
                  <div className="font-bold text-gray-900">박개발자</div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-3">
                  <div className="font-bold text-gray-900">이마케터</div>
      ...
      <div className="bg-[#0f3460] text-white py-16">
        <div className="container-1200">
          <div className="grid md:grid-cols-4 gap-8 text-center max-w-5xl mx-auto">
            ...
            <div>
              <div className="text-4xl font-bold mb-2">0원</div>
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-16">
        <div className="container-1200">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/auth/register"
              className="inline-block bg-gray-900 hover:bg-gray-800 text-white font-bold text-lg px-10 py-4 rounded-lg transition-all"
            >
              3분만에 전문가 등록하기 →
            </Link>
