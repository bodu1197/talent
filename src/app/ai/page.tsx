...
export default function AIServicesPage() {
  ...
  // AI 서비스 카테고리 찾기
  const aiServiceCategory = FULL_CATEGORIES.find(cat => cat.id === 'ai-services')
      ...
      <section id="categories" className="py-16">
        <div className="container-1200">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">원하는 AI 서비스를 선택하고 전문가와 함께 시작하세요</p>
          </div>
      ...
      <section id="cases" className="py-16 bg-gray-50">
        <div className="container-1200">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">실제 비즈니스에서 AI를 어떻게 활용했는지 확인하세요</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-1200">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">AI를 비즈니스에 효과적으로 활용하는 방법을 알아보세요</p>
          </div>
