            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              {order.deliverables && order.deliverables.length > 0 ? (
                <div className="space-y-3">
                  {order.deliverables.map((file: any) => (
                    ...
                    >
                      ...
                      <a
                        href={file.file_url || '#'}
                        download
                        className="px-4 py-2 bg-[#0f3460] text-white rounded-lg hover:bg-[#1a4d8f] transition-colors"
                      >
                  ...
                  {order.status === 'delivered' && (
                    <button className="w-full px-4 py-3 bg-[#0f3460] text-white rounded-lg hover:bg-[#1a4d8f] transition-colors font-medium">
                      <i className="fas fa-download mr-2"></i>
                      전체 다운로드
                    </button>
                  )}
