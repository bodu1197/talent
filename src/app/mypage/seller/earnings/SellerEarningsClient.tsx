...
export default function SellerEarningsClient({ earnings, transactions, sellerData, profileData }: SellerEarningsClientProps) {
  ...
  const handleWithdrawRequest = async () => {
    ...
    try {
      ...
      if (error) {
        console.error('Withdrawal insert error:', JSON.stringify(error, Object.getOwnPropertyNames(error), 2))
        throw error
      }
      ...
      console.error('Withdrawal request error:', JSON.stringify(error, Object.getOwnPropertyNames(error), 2))
  ...
  const handleCancelWithdrawal = async () => {
    ...
    try {
      ...
      console.error('Withdrawal cancel error:', JSON.stringify(error, Object.getOwnPropertyNames(error), 2))
