...
interface SellerProfile
  extends Omit<Seller, "created_at" | "updated_at" | "bio"> {
  display_name?: string;
  bio?: string | null;
            ...
            <div className="space-y-4">
                ...
                <div className="mt-2">
                  <label htmlFor="seller-show-phone" className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setProfile({ ...profile, show_phone: e.target.checked })
                      }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setProfile({ ...profile, kakao_id: e.target.value })
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-transparent"
                />
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        const endTime =
                          profile.contact_hours?.split("-")[1] || "18:00";
                        setProfile({
                          ...profile,
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        const startTime =
                          profile.contact_hours?.split("-")[0] || "09:00";
                        setProfile({
                          ...profile,
