        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between mt-2 text-sm">
              <span className={step >= 1 ? 'text-[#0f3460] font-bold' : 'text-gray-500'}>재능 선택</span>
              <span className={step >= 2 ? 'text-[#0f3460] font-bold' : 'text-gray-500'}>광고 상품</span>
              <span className={step >= 3 ? 'text-[#0f3460] font-bold' : 'text-gray-500'}>정보 입력</span>
              <span className={step >= 4 ? 'text-[#0f3460] font-bold' : 'text-gray-500'}>입금 정보</span>
              <span className={step >= 5 ? 'text-[#0f3460] font-bold' : 'text-gray-500'}>입금 확인</span>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              {services.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-500">모든 서비스에 이미 광고가 활성화되어 있습니다.</p>
                </div>
              ) : (
          ...
          {step === 3 && (
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold mb-2">입금자명 *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold mb-2">사업자 등록번호 (선택)</label>
                  <input
                    type="text"
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, taxInvoiceRequested: e.target.checked })}
                    className="w-4 h-4"
                  />
                  <label htmlFor="taxInvoice" className="text-sm">세금계산서 발행 요청</label>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="bg-blue-50 border-2 border-[#0f3460] rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2">
                  <p><span className="font-bold">은행:</span> {BANK_ACCOUNT.bank}</p>
                  <p><span className="font-bold">계좌번호:</span> {BANK_ACCOUNT.account}</p>
                  <p><span className="font-bold">예금주:</span> {BANK_ACCOUNT.holder}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <p><span className="text-gray-600">상품:</span> {PACKAGES[formData.packageType].name} 플랜</p>
                  <p><span className="text-gray-600">금액:</span> <span className="text-2xl font-bold text-[#0f3460]">{formData.depositAmount.toLocaleString()}원</span></p>
                  <p><span className="text-gray-600">입금자:</span> {formData.depositorName}</p>
                </div>
              </div>
          ...
          {step === 5 && (
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold mb-2">입금 은행 *</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-bold mb-2">입금 날짜 *</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-sm font-bold mb-2">입금 시간 *</label>
                  <input
                    type="time"
                ...
                <div>
                  <label className="block text-sm font-bold mb-2">입금 금액 확인 *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-bold mb-2">입금증 첨부 (선택)</label>
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => {
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  ...
                  disabled={!formData.depositBank || !formData.depositDate || !formData.depositTime || submitting}
                  className="flex-1 bg-[#0f3460] text-white px-6 py-3 rounded-lg hover:bg-[#1a4d8f] disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
