...
export default function AdminServiceRevisionsPage() {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars, sonarjs/no-unused-vars -- Reserved for future approval modal implementation
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars, sonarjs/no-unused-vars -- Reserved for future rejection modal implementation
