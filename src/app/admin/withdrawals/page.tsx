    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-2xl font-bold text-gray-900">{withdrawals.length}건</div>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900">판매자</th>
                ...
                filteredWithdrawals.map((withdrawal) => (
                  <tr key={withdrawal.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm text-gray-600">
                      {new Date(withdrawal.requested_at || withdrawal.created_at).toLocaleDateString('ko-KR')}
                    </td>
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusClass(withdrawal.status)}`}>
