    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{stats?.todayRevenue.toLocaleString()}원</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">{stats?.monthlyOrderCount.toLocaleString()}건</p>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-sm font-medium text-gray-600 mb-2">총 서비스</h3>
          <p className="text-2xl font-bold text-gray-900">{stats?.totalServices.toLocaleString()}개</p>
        </div>
      </div>
