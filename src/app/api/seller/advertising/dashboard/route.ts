...
export async function GET(_request: NextRequest) {
  try {
    ...
    logger.error('Failed to fetch advertising dashboard:', error);
    return NextResponse.json({ error: 'Failed to fetch advertising dashboard' }, { status: 500 });
  }
}
