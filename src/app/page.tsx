      ...
      <section className="py-6 lg:py-7 bg-gray-100 -mt-5 lg:mt-0">
        <div className="container-1200">
          ...
          <div className="md:hidden overflow-x-auto scrollbar-hide -mx-4">
            <div className="flex gap-3 pb-2 pl-4 pr-4" style={{ width: 'calc(100% + 80px)' }}>
              <div className="flex-shrink-0 w-[55%] bg-white rounded-lg p-4 shadow-sm flex items-center gap-3">
