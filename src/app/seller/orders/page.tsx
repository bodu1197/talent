    ...
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">받은 주문을 확인하고 관리하세요.</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">아직 받은 주문이 없습니다.</p>
            <Link href="/seller/services" className="inline-block px-6 py-2 bg-[#0f3460] text-white rounded-lg hover:bg-[#1a4b7d] transition-colors">
              서비스 관리
            </Link>
          </div>
        ) : (
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-sm text-gray-500">판매 금액</div>
                      <div className="text-2xl font-bold text-[#0f3460]">
                        {(order.seller_amount || order.total_amount).toLocaleString()}원
                      </div>
