    ...
    items: [
      {
        ...
        answer: '홈페이지 우측 상단의 "회원가입" 버튼을 클릭하고 이메일과 비밀번호를 입력하시면 됩니다. 소셜 로그인(구글, 카카오)도 가능합니다.',
      },
      {
        question: '비밀번호를 잊어버렸어요.',
        answer: '로그인 페이지에서 "비밀번호 찾기"를 클릭하고 가입 시 등록한 이메일을 입력하시면 비밀번호 재설정 링크가 전송됩니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '원하는 서비스를 선택하고 패키지를 고른 후 결제하기 버튼을 클릭하세요. 결제 완료 후 판매자와 채팅으로 작업을 시작할 수 있습니다.',
      },
      {
      ...
      {
        question: '환불은 가능한가요?',
        answer: '작업 시작 전이라면 전액 환불이 가능합니다. 작업 진행 중에는 진행 정도에 따라 부분 환불이 가능하며, 완료 후에는 환불이 불가능합니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '마이페이지에서 "판매자 전환" 메뉴를 선택하고 필요한 정보를 입력하시면 됩니다. 심사 후 승인되면 서비스를 등록할 수 있습니다.',
      },
      {
        question: '수수료는 얼마인가요?',
      ...
      },
      {
        ...
        answer: '최소 정산 금액인 10,000원 이상이 되면 언제든지 정산 신청이 가능하며, 신청 후 1-3 영업일 내에 입금됩니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '구매자와 판매자 간 분쟁이 발생하면 고객센터에 중재를 요청하실 수 있습니다. 공정한 심사를 통해 해결해드립니다.',
      },
      {
        question: '서비스 이용 중 문제가 생기면 어디로 문의하나요?',
        answer: '고객센터의 1:1 문의를 이용하시거나 이메일(support@example.com)로 문의해주세요. 평일 09:00-18:00에는 전화 상담(1234-5678)도 가능합니다.',
      },
    ],
  },
]
          ...
          <div key={categoryIndex} className="mb-12">
            ...
            <div className="space-y-4">
              {category.items.map((item, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    <button
