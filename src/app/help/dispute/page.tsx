...
import { Scale, AlertCircle, Upload, X, ChevronRight, FileText, MessageSquare, Clock } from 'lucide-react';
...
const DISPUTE_TYPES = [
  { value: 'refund', label: '환불 요청', description: '서비스가 제공되지 않았거나 취소하고 싶습니다' },
  { value: 'quality', label: '서비스 품질 불만', description: '제공된 서비스가 기대에 미치지 못합니다' },
  { value: 'mismatch', label: '계약 내용과 다름', description: '서비스 설명과 실제 제공 내용이 다릅니다' },
  { value: 'no_response', label: '무응답/연락두절', description: '판매자/구매자가 연락이 되지 않습니다' },
  { value: 'extra_charge', label: '추가 비용 분쟁', description: '예상치 못한 추가 비용이 청구되었습니다' },
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col items-center text-center flex-1">
              ...
              <span className="text-sm mt-2 text-gray-500">상대방 답변<br />(72시간)</span>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-300" />
            <div className="flex flex-col items-center text-center flex-1">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            {orders.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                <p>진행 중인 주문이 없습니다.</p>
                <Link href="/mypage/orders" className="text-blue-600 hover:underline mt-2 inline-block">
                  주문 내역 확인하기
                </Link>
              </div>
            ) : (
                ...
                {orders.slice(0, 5).map((order) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium text-gray-900">{order.service?.title || '서비스 정보 없음'}</p>
