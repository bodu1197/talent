...
describe("Auth Config", () => {
  ...
  describe("isAllowedOrigin", () => {
    ...
    it("should return true for production origin", () => {
      expect(isAllowedOrigin("https://talent-zeta.vercel.app")).toBe(true);
    });
    ...
    it("should return false for similar but different origins", () => {
      ...
      expect(isAllowedOrigin("https://talent-zeta.vercel.app.evil.com")).toBe(
        false,
      );
    });
    ...
    it("should be case-sensitive", () => {
      ...
      expect(isAllowedOrigin("HTTPS://talent-zeta.vercel.app")).toBe(false);
    });
  });
  ...
  describe("getSecureRedirectUrl", () => {
    ...
    it("should work with production origin", () => {
      const url = getSecureRedirectUrl("https://talent-zeta.vercel.app");
      expect(url).toBe("https://talent-zeta.vercel.app/auth/callback");
    });
