/* eslint-disable sonarjs/no-clear-text-protocols -- Testing localhost URLs requires http:// protocol */
...
describe('Auth Config', () => {
  describe('Constants', () => {
    it('should have correct allowed redirect origins', () => {
      expect(ALLOWED_REDIRECT_ORIGINS).toEqual(['http://localhost:3000', 'https://dolpagu.com']);
