/* eslint-disable @typescript-eslint/no-explicit-any, sonarjs/no-nested-functions -- Test mocks require flexible typing and nested describe/it blocks */
      ...
      const mockServices = [
        {
          ...
          thumbnail_url: 'thumb.jpg',
          orders_count: 10,
          seller: [{ id: 'seller-1', business_name: 'Business', is_verified: true }],
        ...
        },
        {
          ...
          orders_count: 5,
          seller: [{ id: 'seller-2', business_name: 'Business 2', is_verified: false }],
          service_categories: [{ category_id: 'cat-1' }],
        },
      ];
