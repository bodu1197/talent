...
describe("Supabase Queries - Admin", () => {
      ...
      const mockData = [
        {
          ...
          buyer: { id: "buyer-1", name: "Buyer Name", email: "buyer@test.com" },
          seller: {
            id: "seller-1",
            name: "Seller Name",
  ...
  describe("approveServiceRevision", () => {
    ...
    it("should throw error on RPC failure", async () => {
      ...
      await expect(approveServiceRevision("revision-1")).rejects.toEqual(
        mockError,
      );
    });
  });
  ...
  describe("rejectServiceRevision", () => {
    ...
    it("should throw error on update failure", async () => {
      ...
      await expect(rejectServiceRevision("revision-1")).rejects.toEqual(
        mockError,
      );
    });
  });
  ...
  describe("getServiceRevisionDetail", () => {
    it("should return detailed revision with categories", async () => {
      ...
      const mockQueries = {
        revisionQuery: {
          ...
          single: vi
            .fn()
            .mockResolvedValue({ data: mockRevision, error: null }),
        },
        serviceQuery: {
          select: vi.fn().mockReturnThis(),
          eq: vi.fn().mockReturnThis(),
        ...
        serviceCategoriesQuery: {
          ...
          eq: vi
            .fn()
            .mockResolvedValue({ data: mockServiceCategoryLinks, error: null }),
        },
        ...
        categoriesQuery1: {
          ...
          in: vi
            .fn()
            .mockResolvedValue({ data: [mockCategories[0]], error: null }),
        },
        categoriesQuery2: {
          select: vi.fn().mockReturnThis(),
          in: vi
            .fn()
            .mockResolvedValue({ data: [mockCategories[1]], error: null }),
        },
        sellerQuery: {
          select: vi.fn().mockReturnThis(),
          eq: vi.fn().mockReturnThis(),
      ...
      vi.mocked(createClient).mockReturnValue({
        from: vi.fn((table) => {
          ...
          if (table === "service_categories")
            return mockQueries.serviceCategoriesQuery;
          if (table === "service_revision_categories")
            return mockQueries.revisionCategoriesQuery;
          if (table === "categories") {
            callIndex++;
    ...
    it("should throw error on query failure", async () => {
      ...
      await expect(getServiceRevisionDetail("invalid-id")).rejects.toEqual(
        mockError,
      );
    });
  });
