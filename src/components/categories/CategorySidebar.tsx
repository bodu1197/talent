...
export default function CategorySidebar({ categories, currentCategoryId, categoryPath }: CategorySidebarProps) {
            ...
            <div key={category1.id} className="mb-1">
              ...
              >
                ...
                {category1.children && category1.children.length > 0 && (
                  <i className={`fas fa-chevron-right text-xs text-gray-400 transition-transform duration-200 ${
