            ...
            {user ? (
              ...
              <>
                ...
                <div className="relative group">
                  <button
                    className="px-3 py-2 bg-white rounded-lg border border-gray-200 flex items-center justify-center text-gray-700 hover:text-brand-primary transition-colors"
                    aria-label="주문 관리"
                  >
                ...
                <Link
                  ...
                  className="w-10 h-10 bg-white rounded-lg border border-gray-200 flex items-center justify-center text-gray-700 hover:text-red-500 transition-colors"
                  aria-label="찜한 서비스"
                >
                ...
                {/* 채팅 */}
                <button
                  className="w-10 h-10 bg-white rounded-lg border border-gray-200 flex items-center justify-center text-gray-700 hover:text-brand-primary transition-colors"
                  aria-label="채팅"
                >
