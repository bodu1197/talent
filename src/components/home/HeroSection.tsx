...
const slides: Slide[] = [
  {
    ...
    // Jackson Pollock 액션 페인팅 스타일 - 다양한 크기의 격렬한 비산
    splatterPattern: [
      // 거대한 임팩트 (왼쪽 텍스트 침범)
