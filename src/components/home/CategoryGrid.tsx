...
export default function CategoryGrid() {
  ...
  return (
    <section className="py-6 lg:py-8 bg-white lg:-mt-10">
            ...
            <div className="flex gap-0 overflow-x-auto pb-2 scrollbar-hide">
              {topLevelCategories.slice(0, 11).map((category, index) => (
                ...
                >
                  ...
                  <div className="text-gray-700 group-hover:text-[#0f3460] transition-colors duration-200 font-bold text-mobile-sm text-center w-[76px] whitespace-nowrap px-0">{category.name}</div>
                </Link>
              ))}
            </div>
