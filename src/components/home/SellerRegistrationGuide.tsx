...
function BenefitCard({ iconBg, iconColor, iconPath, title, description }: BenefitCardProps) {
  return (
    <div className="bg-white rounded-xl p-4 md:p-5 shadow-sm hover:shadow-md transition-shadow flex-shrink-0 w-[200px] snap-start md:w-auto md:snap-align-none">
      <div
        className={`w-10 h-10 md:w-11 md:h-11 ${iconBg} rounded-lg flex items-center justify-center mb-3`}
      >
        <svg
...
const benefits: BenefitCardProps[] = [
  {
    ...
    title: '수수료 0원',
    description: '판매 수수료 없이 100% 수익을 가져가세요',
  },
  {
    ...
    title: '기회균등',
    description: '신규 전문가도 동등한 노출 기회를 드립니다',
  },
  {
    iconBg: 'bg-blue-100',
    ...
    title: '수익 창출',
    description: '당신의 전문성으로 안정적인 수익을 만들어보세요',
  },
  {
    iconBg: 'bg-green-100',
    ...
    title: '넓은 고객층',
    description: '다양한 고객들과 연결되어 비즈니스를 확장하세요',
  },
  {
    ...
    title: '안전한 거래',
    description: '신뢰할 수 있는 결제 시스템으로 안전하게 거래하세요',
  },
];
