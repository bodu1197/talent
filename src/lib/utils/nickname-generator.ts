...
export function generateProfileImage(nickname: string): string {
  // DiceBear의 Avataaars 스타일 사용 (성별 중립적)
  return `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(nickname)}&backgroundColor=b6e3f4,c0aede,d1d4f9`
}
