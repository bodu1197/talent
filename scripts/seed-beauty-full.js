...
const LOCATIONS = [
  ...
  // 종로구 (3명)
  { region: '종로구', lat: 37.573, lng: 126.9794, address: '서울특별시 종로구 종로3가 51' },
  { region: '종로구', lat: 37.5796, lng: 126.977, address: '서울특별시 종로구 삼청동 35-4' },
  ...
  { region: '영등포구', lat: 37.5264, lng: 126.8964, address: '서울특별시 영등포구 여의도동 23' },
  {
    ...
    lat: 37.5169,
    lng: 126.9073,
    address: '서울특별시 영등포구 영등포동 618-14',
  },
  ...
  { region: '성동구', lat: 37.5477, lng: 127.044, address: '서울특별시 성동구 왕십리동 16-17' },
  { region: '성동구', lat: 37.5475, lng: 127.0564, address: '서울특별시 성동구 행당동 286-4' },
  // 용산구 (3명)
  { region: '용산구', lat: 37.5326, lng: 126.991, address: '서울특별시 용산구 한남동 657-9' },
  { region: '용산구', lat: 37.534, lng: 126.9656, address: '서울특별시 용산구 이태원동 34-67' },
  ...
  'nail-art': [
    {
      title: '프리미엄 젤네일 아트',
      description:
        '트렌디한 젤네일 아트를 제공합니다. 시즌별 최신 디자인, 고급 젤 제품 사용. 15년 경력의 네일 아티스트가 직접 시술합니다. 원하시는 디자인 사진을 가져오시면 100% 재현해 드립니다.',
      price: 70000,
    },
    {
      title: '웨딩 네일 풀패키지',
      description:
        '신부님을 위한 프리미엄 웨딩 네일! 손톱, 발톱 모두 완벽하게 케어해 드립니다. 드레스와 부케에 어울리는 맞춤 디자인 제안. 본식 당일 리터치 서비스 포함.',
      price: 180000,
    },
    {
      title: '캐릭터 & 아트 네일',
      description:
        '귀여운 캐릭터부터 화려한 아트까지! SNS 핫한 디자인 전문. 디즈니, 산리오, 짱구 등 인기 캐릭터 재현 가능. 사진 첨부 시 견적 무료.',
      price: 90000,
    },
    {
      title: '스파 패디큐어 & 발관리',
      description:
        '지친 발에 럭셔리한 휴식을 선사합니다. 각질 제거, 보습 케어, 발 마사지, 네일 아트까지 풀코스. 피로 해소에 효과적인 아로마 오일 사용.',
      price: 85000,
    },
    {
      title: '젤 연장 & 보수 전문',
      description:
        '자연스럽고 튼튼한 젤 연장! 짧은 손톱도 아름다운 길이감을 연출해 드립니다. 파손된 네일 긴급 보수도 가능. 당일 예약 환영.',
      price: 95000,
    },
  ],
  makeup: [
    {
      title: '웨딩 메이크업 & 헤어',
      description:
        '인생에서 가장 아름다운 날을 위한 특별한 메이크업. 15년 경력 웨딩 메이크업 아티스트가 신부님의 아름다움을 최대한 끌어올려 드립니다. 리허설 메이크업 포함.',
      price: 280000,
    },
    {
      title: '데일리 메이크업 레슨',
      description:
        '나에게 맞는 데일리 메이크업을 배워보세요! 피부 톤, 눈 모양에 맞는 메이크업 기법 전수. 1:1 맞춤 레슨으로 누구나 예뻐질 수 있습니다. 화장품 추천 리스트 제공.',
      price: 100000,
    },
    {
      title: '파티 & 이벤트 메이크업',
      description:
        '특별한 날을 더욱 빛나게! 연예인 담당 메이크업 아티스트의 프리미엄 메이크업. 시상식, 생일파티, 데이트 등 어떤 자리에서도 주인공이 되세요.',
      price: 180000,
    },
    {
      title: '증명사진 & 프로필 메이크업',
      description:
        '면접, 여권, 프로필 사진을 위한 깔끔한 메이크업. 사진에 잘 받는 음영과 컬러로 자신감 있는 이미지를 연출해 드립니다. 헤어 스타일링 기본 포함.',
      price: 70000,
    },
    {
      title: 'SFX 특수 메이크업',
      description:
        '할로윈, 코스프레, 영상 촬영을 위한 특수 메이크업! 좀비, 상처, 판타지 캐릭터까지 무엇이든 가능합니다. 포트폴리오 상담 후 진행.',
      price: 150000,
    },
  ],
  'hair-styling': [
    {
      title: '출장 헤어 스타일링',
      description:
        '결혼식, 졸업식, 파티 등 특별한 날 원하시는 장소로 출장 방문합니다. 업스타일, 다운스타일, 반머리 등 다양한 스타일 가능. 액세서리 제공.',
      price: 120000,
    },
    {
      title: '웨딩 헤어 스타일링',
      description:
        '신부님의 드레스와 컨셉에 맞는 우아한 헤어스타일을 연출해 드립니다. 본식 + 리허설 패키지 할인. 헤어 액세서리 무료 대여.',
      price: 200000,
    },
    {
      title: '남성 헤어컷 & 스타일링',
      description:
        '트렌디한 남성 헤어스타일을 제안합니다. 두상과 얼굴형에 맞는 맞춤 커트. 투블럭, 리젠트, 포마드 스타일링까지 토탈 케어.',
      price: 40000,
    },
    {
      title: '두피 & 탈모 관리 프로그램',
      description:
        '두피 분석 및 맞춤형 탈모 관리 프로그램. 20년 경력 두피 전문가가 직접 상담하고 관리합니다. 홈케어 제품 추천 포함.',
      price: 80000,
    },
    {
      title: '펌 & 염색 전문샵',
      description:
        '손상 최소화! 프리미엄 펌 & 염색 서비스. 에어리펌, 히피펌, 볼륨펌 등 최신 트렌드 스타일. 발색 좋은 고급 염색약 사용.',
      price: 130000,
    },
  ],
  'styling-consulting': [
    {
      title: '옷장 정리 & 스타일링',
      description:
        '옷장 속 옷으로 새로운 스타일링! 불필요한 옷 정리, 기존 옷 활용 코디 제안. 계절별 캡슐 워드로브 구성 방법까지 알려드립니다.',
      price: 150000,
    },
    {
      title: '쇼핑 동행 스타일링',
      description:
        '함께 쇼핑하며 나만의 스타일을 완성해드립니다. 체형과 예산에 맞는 쇼핑 가이드. 백화점, SPA 브랜드, 빈티지샵 등 원하는 곳 어디든!',
      price: 180000,
    },
    {
      title: '면접 & 비즈니스 스타일링',
      description:
        '첫인상이 중요한 순간! 면접, 프레젠테이션, 비즈니스 미팅을 위한 전문 스타일링. 업종에 맞는 이미지 컨설팅 포함.',
      price: 130000,
    },
    {
      title: '데이트 & 소개팅 스타일링',
      description:
        '소중한 만남을 위한 특별한 준비! 퍼스널 컬러, 체형에 맞는 데이트룩 제안. 액세서리, 향수까지 토탈 스타일링.',
      price: 100000,
    },
    {
      title: '시즌별 코디 컨설팅',
      description:
        '봄/여름/가을/겨울 계절에 맞는 코디 가이드. 트렌드 분석 + 개인 스타일 제안. 온라인 팔로업 1개월 무료.',
      price: 120000,
    },
  ],
  'personal-color': [
    {
      title: '퍼스널 컬러 진단 (프리미엄)',
      description:
        '나에게 어울리는 컬러를 찾아드립니다. 봄웜/여름쿨/가을웜/겨울쿨 상세 진단. 베스트/워스트 컬러 팔레트 제공. 메이크업, 헤어, 패션 컬러 가이드 포함.',
      price: 120000,
    },
    {
      title: '웜톤 컬러 컨설팅',
      description:
        '웜톤 확정자를 위한 심화 컨설팅! 봄웜/가을웜 세부 진단. 웜톤에 어울리는 립, 아이섀도우, 의류 색상 상세 가이드.',
      price: 90000,
    },
    {
      title: '쿨톤 컬러 컨설팅',
      description:
        '쿨톤 확정자를 위한 심화 컨설팅! 여름쿨/겨울쿨 세부 진단. 쿨톤에 어울리는 메이크업, 패션 컬러 집중 분석.',
      price: 90000,
    },
    {
      title: '퍼스널 컬러 메이크업',
      description:
        '퍼스널 컬러에 맞는 메이크업을 직접 배워보세요. 진단 + 메이크업 레슨 + 화장품 추천 리스트까지 원스톱 서비스.',
      price: 150000,
    },
    {
      title: '헤어 컬러 컨설팅',
      description:
        '퍼스널 컬러에 맞는 최적의 헤어 컬러를 찾아드립니다. 염색 색상 추천, 헤어 살롱 동행 서비스 가능. 홈케어 방법 안내.',
      price: 80000,
    },
  ],
};
...
async function main() {
  ...
  // 1. 기존 판매자 확인
  const { data: existingSellers } = await supabase.from('sellers').select('id, user_id').limit(100);
  ...
  const testUsers =
    authUsers?.users?.filter(
      (u) => u.email?.includes('beauty-seller') && u.email?.includes('@test.dolpagu.com')
    ) || [];
