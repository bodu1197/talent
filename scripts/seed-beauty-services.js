...
const LOCATIONS = [
  ...
  { region: '종로구', lat: 37.573, lng: 126.9794, address: '서울특별시 종로구 종로3가' },
  ...
  { region: '용산구', lat: 37.5326, lng: 126.991, address: '서울특별시 용산구 한남동' },
];
  ...
  makeup: [
    {
      title: '웨딩 메이크업 전문',
      description:
        '10년 경력 웨딩 메이크업 아티스트입니다. 신부님의 아름다움을 최대한 끌어올려 드립니다. 드레스 스타일에 맞춘 맞춤 메이크업을 제공합니다.',
      price: 200000,
    },
    {
      title: '데일리 메이크업 레슨',
      description:
        '자연스러운 데일리 메이크업을 배워보세요. 본인에게 맞는 색조와 기법을 알려드립니다.',
      price: 80000,
    },
    {
      title: '파티 & 이벤트 메이크업',
      description:
        '특별한 날을 위한 화려한 메이크업. 연예인 담당 메이크업 아티스트가 직접 진행합니다.',
      price: 150000,
    },
    {
      title: '증명사진 메이크업',
      description: '면접, 여권, 프로필 사진을 위한 깔끔한 메이크업을 제공합니다.',
      price: 50000,
    },
  ],
  hair: [
    {
      title: '출장 헤어 스타일링',
      description: '결혼식, 졸업식, 파티 등 특별한 날 출장 헤어 스타일링 서비스를 제공합니다.',
      price: 100000,
    },
    {
      title: '남성 헤어컷 & 스타일링',
      description: '트렌디한 남성 헤어스타일을 제안합니다. 두상과 얼굴형에 맞는 커트를 진행합니다.',
      price: 30000,
    },
    {
      title: '탈모 관리 상담',
      description: '두피 분석 및 맞춤형 탈모 관리 프로그램을 제공합니다. 20년 경력 두피 전문가.',
      price: 50000,
    },
    {
      title: '웨딩 헤어 스타일링',
      description: '신부님의 드레스와 컨셉에 맞는 우아한 헤어스타일을 연출해 드립니다.',
      price: 180000,
    },
  ],
  nail: [
    {
      title: '젤네일 아트 (손)',
      description:
        '트렌디한 젤네일 아트를 제공합니다. 시즌별 다양한 디자인 제안. 고급 젤 제품 사용.',
      price: 60000,
    },
    {
      title: '패디큐어 & 발관리',
      description: '지친 발에 휴식을! 각질 제거부터 네일 아트까지 풀코스 발관리.',
      price: 70000,
    },
    {
      title: '웨딩 네일 패키지',
      description: '손톱, 발톱 모두 완벽하게! 신부님을 위한 프리미엄 웨딩 네일 패키지.',
      price: 150000,
    },
    {
      title: '네일 연장 & 보수',
      description: '자연스러운 길이감! 젤 연장 및 파손된 네일 보수 서비스.',
      price: 80000,
    },
  ],
  skin: [
    {
      title: '피부 관리 1:1 코칭',
      description: '피부 타입 분석 후 맞춤형 스킨케어 루틴을 제안합니다. 화장품 추천 포함.',
      price: 50000,
    },
    {
      title: '페이셜 마사지 & 관리',
      description: '림프 마사지와 함께하는 프리미엄 페이셜 케어. 피부 탄력과 혈색을 되찾으세요.',
      price: 80000,
    },
    {
      title: '여드름 집중 관리',
      description: '여드름, 모공, 피지 고민 해결! 피부과 근무 경력 에스테티션의 전문 관리.',
      price: 90000,
    },
    {
      title: '브라이달 피부 관리',
      description: '결혼 전 3개월 집중 피부 관리 프로그램. 광채나는 피부로 가꿔드립니다.',
      price: 300000,
    },
  ],
  styling: [
    {
      title: '퍼스널 컬러 진단',
      description:
        '나에게 어울리는 컬러를 찾아드립니다. 계절 타입 분석 및 베스트/워스트 컬러 제안.',
      price: 80000,
    },
    {
      title: '옷장 정리 & 스타일링',
      description: '옷장 속 옷으로 새로운 스타일링! 불필요한 옷 정리 및 코디 제안.',
      price: 100000,
    },
    {
      title: '쇼핑 동행 스타일링',
      description: '함께 쇼핑하며 스타일을 완성해드립니다. 체형과 예산에 맞는 쇼핑 가이드.',
      price: 150000,
    },
    {
      title: '면접 & 비즈니스 스타일링',
      description: '첫인상이 중요한 순간! 면접, 프레젠테이션을 위한 전문 스타일링.',
      price: 120000,
    },
  ],
};
...
async function main() {
  ...
  if (!sellers || sellers.length === 0) {
    ...
    // 기존 판매자 조회 (위치 없는)
    const { data: existingSellers } = await supabase.from('sellers').select('id').limit(8);
  ...
  sellers.forEach((s) =>
    console.log(`  - ${s.id.slice(0, 8)}... (${s.location_region || '위치 없음'})`)
  );
